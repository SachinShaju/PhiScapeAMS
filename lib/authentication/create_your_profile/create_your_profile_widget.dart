...
class _CreateYourProfileWidgetState extends State<CreateYourProfileWidget> {
  ...
  void initState() {
    ...
    _model.deptController ??= TextEditingController();
    _model.deptFocusNode ??= FocusNode();
                          ...
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                Expanded(
                                  child: TextFormField(
                                    controller: _model.deptController,
                                    focusNode: _model.deptFocusNode,
                                    textCapitalization:
                                        TextCapitalization.words,
                                    obscureText: false,
                                    decoration: InputDecoration(
                                    ...
                                    cursorColor:
                                        FlutterFlowTheme.of(context).primary,
                                    validator: _model.deptControllerValidator
                                        .asValidator(context),
                                  ),
                                ),
                              ],
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              await currentUserReference!
                                ...
                                dept: _model.deptController.text,
                                address: _model.addressController.text,
                              ));
                              if (valueOrDefault(
                                      currentUserDocument?.status, '') ==
                                  'cancel') {
                                context.pushNamed('cancelled_page');
                              } else {
                                if (valueOrDefault(
                                        currentUserDocument?.status, '') ==
                                    'pending') {
                                  context.pushNamed('pending_page');
                                } else {
